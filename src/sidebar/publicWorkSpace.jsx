...
import { deleteAction, getUserDetails, menuActonHandle, moveAction, renameAction, getEditorData } from '../services/meService';
import DropDown, { DropDownItem } from '../ui/DropDown';
import { convertToNestedJson } from '../utils/convertToNestedJson';

const PublicWorkSpace = ({ initialTreeData, sendEditorData, setUserDetails }) => {

  const [treeData, setTreeData] = useState(initialTreeData?.data?.publicNodes);
  ...
  useEffect(() => {
    if (initialTreeData?.data) {
      ...
      FlatenTreeData(copyTreeData.publicNodes);
    }
  }, [initialTreeData])
...
export default connect(mapStateToProps, mapDispatchToProps)(PublicWorkSpace);